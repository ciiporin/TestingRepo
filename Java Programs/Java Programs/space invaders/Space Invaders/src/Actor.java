...
public class Actor implements Stage {
    ...
    //tells the main method that the actor is removable
     ...
     //   g.drawImage( spriteCache.getSprite(spriteNames[currentFrame]), x,y, currentFrame, currentFrame, null, stage );
      }
   ...
   public Rectangle getBounds() {
	...
	public void paint(Graphics2D g) {
			...
			g.drawRenderedImage(bufferedImage,transformer.getTranslateInstance(actorX,actorY));
