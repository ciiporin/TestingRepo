...
public class Calculator implements ActionListener {
	...
	public JMenuBar createMenuBar() {
		...
		menuItem1 = new JMenuItem(new ImageIcon("images/middle.gif"));
		...
		menuItem1 = new JMenuItem("An item in the submenu");
		menuItem1.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_2,
				ActionEvent.ALT_MASK));
		submenu.add(menuItem1);

		menuItem1 = new JMenuItem("Another item");
		submenu.add(menuItem1);
		menu.add(submenu);
	...
	JButton buttonRoot = new JButton("SQRT");
	JButton buttonPercent = new JButton("%");
	JButton buttonBack = new JButton("Backspace");
	JButton buttonDivOne = new JButton("1/x");
	...
	Calculator() {
		...
		buttonRoot.addActionListener(calcEngine);
		...
		buttonDivOne.addActionListener(calcEngine);
